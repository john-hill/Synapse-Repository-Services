...
public class SynapseAdminClientImpl extends SynapseClientImpl implements SynapseAdminClient {
	...
	public LoginResponse createIntegrationTestUser(NewIntegrationTestUser user) throws SynapseException {
		...
		return postJSONEntity(getRepoEndpoint(), ADMIN_USER, user, LoginResponse.class);
	}
	...
	@Override
	public AsynchronousJobStatus startAdminAsynchronousJob(AsynchronousAdminRequestBody adminRequest) throws SynapseException {
		if (adminRequest == null)
			throw new IllegalArgumentException("JobBody cannot be null");
		String url = ADMIN_ASYNCHRONOUS_JOB;
		return postJSONEntity(getRepoEndpoint(), url, adminRequest,
	...
	@Override
	public Realm createRealm(Realm realm) throws SynapseException {
		if (realm == null)
			throw new IllegalArgumentException("realm cannot be null.");
		String url = ADMIN + REALM;
		return postJSONEntity(getRepoEndpoint(), url, realm,
				Realm.class);
	}
