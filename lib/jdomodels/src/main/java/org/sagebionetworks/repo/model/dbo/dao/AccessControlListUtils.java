...
public class AccessControlListUtils {
	...
	public static Map<ObjectType, Set<ACCESS_TYPE>> ALLOWED_ACCESS_TYPES = Map.of(
			...
			ObjectType.PORTAL, Set.of(ACCESS_TYPE.CREATE, ACCESS_TYPE.READ, ACCESS_TYPE.UPDATE, ACCESS_TYPE.DELETE, ACCESS_TYPE.CHANGE_PERMISSIONS, ACCESS_TYPE.MINT_DOI),
			ObjectType.OAUTH_CLIENT, Set.of(ACCESS_TYPE.READ, ACCESS_TYPE.CHANGE_PERMISSIONS, ACCESS_TYPE.DELETE, ACCESS_TYPE.UPDATE)
	);
