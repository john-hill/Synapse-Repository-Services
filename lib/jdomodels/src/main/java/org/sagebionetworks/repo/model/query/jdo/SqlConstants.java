...
public class SqlConstants {
	...
	public static final String COL_SEARCH_CONFIG_SYNONYM_SET_IDS	= "SYNONYM_SET_IDS";
	public static final String COL_SEARCH_CONFIG_COL_ANALYZER_IDS	= "COLUMN_ANALYZER_OVERRIDE_IDS";
