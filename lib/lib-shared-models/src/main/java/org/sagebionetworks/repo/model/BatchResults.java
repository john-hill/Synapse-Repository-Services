...
public class BatchResults<T extends JSONEntity> implements JSONEntity {
	 ...
	 * Default constructor
	 */
	public BatchResults(Class<? extends T> clazz) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BatchResults other = (BatchResults) obj;
		if (results == null) {
