CREATE TABLE IF NOT EXISTS ANNOTATION_REPLICATION(
	...
	STRING_VALUE VARCHAR(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
	...
	PRIMARY KEY(OBJECT_TYPE, OBJECT_ID, OBJECT_VERSION, ANNO_KEY, ANNO_TYPE),
	INDEX `STRING_VALUE_IDX`(STRING_VALUE(500)),
	CONSTRAINT `OBJECT_ID_OBJECT_TYPE_FK` FOREIGN KEY (OBJECT_TYPE, OBJECT_ID, OBJECT_VERSION) REFERENCES OBJECT_REPLICATION (OBJECT_TYPE, OBJECT_ID, OBJECT_VERSION) ON DELETE CASCADE
)