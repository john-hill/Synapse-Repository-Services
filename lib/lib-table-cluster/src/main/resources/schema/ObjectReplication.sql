CREATE TABLE IF NOT EXISTS OBJECT_REPLICATION (
    ...
    SUBTYPE ENUM('dockerrepo','entityview','file','folder','link','project','submission','submissionview','table','dataset', 'datasetcollection', 'materializedview', 'virtualtable', 'recordset', 'searchindex') NOT NULL,
    ...
    FILE_STORAGE_LOCATION_ID BIGINT DEFAULT NULL,
    ...
    INDEX (MODIFIED_BY),
    INDEX (MODIFIED_ON),
    INDEX PROJECT_ID_STORAGE_LOCATION_ID (PROJECT_ID, FILE_STORAGE_LOCATION_ID)
    )