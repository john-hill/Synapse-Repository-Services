...
public class PredicateTest {
	...
	public void testPredicateToSQLComparisonPredicate() throws ParseException{
		ComparisonPredicate comparisonPredicate = SqlElementUtils.createComparisonPredicate("foo >= 123.4");
	...
	public void testPredicateToSQLBetweenPredicate() throws ParseException{
		BetweenPredicate betweenPredicate = SqlElementUtils.createBetweenPredicate("bar between 0.0 and 1.0");
	...
	public void testPredicateToSQLInPredicate() throws ParseException{
		InPredicate inPredicate = SqlElementUtils.createInPredicate("bar in (2,3,5)");
	...
	public void testPredicateToSQLLikePredicate() throws ParseException{
		LikePredicate likePredicate = SqlElementUtils.createLikePredicate("bar like '%suffix'");
	...
	public void testPredicateToSQLNullPredicate() throws ParseException{
		NullPredicate nullPredicate = SqlElementUtils.createNullPredicate("foo is null");
	...
	public void testPredicateToSQLNotNullPredicate() throws ParseException {
		NullPredicate nullPredicate = SqlElementUtils.createNullPredicate("foo is not null");
		Predicate element = new Predicate(nullPredicate);
	...
	public void testBooleanTestSQLPrimaryIsBooleanTrue() throws ParseException {
		BooleanPrimary booleanPrimary = SqlElementUtils.createBooleanPrimary("foo is true");
	...
	public void testBooleanTestSQLPrimaryIsBooleanFalse() throws ParseException {
		BooleanPrimary booleanPrimary = SqlElementUtils.createBooleanPrimary("foo is fAlse");
	...
	public void testBooleanTestSQLPrimaryIsBooleanNotTrue() throws ParseException {
		BooleanPrimary booleanPrimary = SqlElementUtils.createBooleanPrimary("foo is not true");
	...
	public void testBooleanTestSQLPrimaryIsBooleanNotFalse() throws ParseException {
		BooleanPrimary booleanPrimary = SqlElementUtils.createBooleanPrimary("foo is not false");
	...
	public void testBooleanTestSQLPrimaryIsBooleanEqualsTrue() throws ParseException {
		BooleanPrimary booleanPrimary = SqlElementUtils.createBooleanPrimary("foo = true");
	...
	public void testBooleanTestSQLPrimaryIsBooleanEqualsFalse() throws ParseException {
		BooleanPrimary booleanPrimary = SqlElementUtils.createBooleanPrimary("foo <> fAlse");
