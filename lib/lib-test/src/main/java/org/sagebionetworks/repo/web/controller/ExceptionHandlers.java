...
public class ExceptionHandlers {
	...
	public static final TestEntry[] testEntries = new TestEntry[] {
		...
		new TestEntry(503,
				...
				new ExceptionType("org.springframework.transaction.CannotCreateTransactionException", true)),
		new TestEntry(412,
		...
		new TestEntry(400,
				...
				new ExceptionType("org.sagebionetworks.repo.web.WebhookDomainUnsupportedException", true)),
		new TestEntry(406,
