 ...
 * but discarded after). Within a grid session the trusted {@code GridAgentSessionContext}
 * carried in the tool context lets it resolve and describe the grid's currently-bound schema
 * without being handed a $id.
 */
public class JsonSchemaSpecialist implements Agent {
