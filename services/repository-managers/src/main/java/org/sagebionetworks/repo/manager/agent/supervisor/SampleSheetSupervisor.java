 ...
 * workflow and delegate focused sub-tasks. It is given only the focused subset of specialist
 * delegation tools it needs (selected by its factory) and can also run Python directly on the
 * shared code interpreter session via {@link CodeInterpreterTools}. Each instance maintains its own
