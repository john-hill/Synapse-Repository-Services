...
public class SupervisorTools {
	...
	@Tool(name = TOOL_JSON_SCHEMA, description = "Delegate a task about a Synapse JSON schema to the JSON schema specialist. "
	...
	@Tool(name = TOOL_FILE_SUMMARY, description = "Delegate a task to the file summary specialist to inspect and summarize a file already "
	...
	@Tool(name = TOOL_ENTITY_METADATA, description = "Delegate a task about a Synapse entity's metadata to the entity metadata specialist. "
	...
	@Tool(name = TOOL_GRID_QUERY, description = "Delegate a task about the current grid session to the grid query specialist. "
	...
	@Tool(name = TOOL_GRID_UPDATE, description = "Delegate a task about the current grid session to the grid update specialist. "
