...
public class CopyReaderImpl implements CopyReader {
	...
	public CopyReaderImpl(GridReplicaViewManager gridReplicaViewManager, GridReplicaSupport gridReplicaSupport,
