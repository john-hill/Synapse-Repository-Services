 ...
 * grid copy (CRDT replica) and its source of truth. The synchronization
 * process ensures consistency between the user's local changes and external
 * changes made to the source.
 */
public interface GridSynchronizationManager {

 /**
  * Synchronizes a grid copy with its source of truth using a two-phase
  * approach:
  *
  * <p>
