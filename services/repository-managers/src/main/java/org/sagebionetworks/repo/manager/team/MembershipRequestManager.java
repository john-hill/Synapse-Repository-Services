...
public interface MembershipRequestManager {
	 ...
	 * @throws NotFoundException
	 */
	public PaginatedResults<MembershipRequest> getOpenByTeamInRange(UserInfo userInfo, Long teamId, long limit, long offset) throws DatastoreException, NotFoundException;
	 ...
	 * @throws NotFoundException
	 */
	public PaginatedResults<MembershipRequest> getOpenByTeamAndRequestorInRange(UserInfo userInfo, Long teamId, Long requestorId, long limit, long offset) throws DatastoreException, NotFoundException;
