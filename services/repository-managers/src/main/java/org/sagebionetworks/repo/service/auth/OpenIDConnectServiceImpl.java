...
public class OpenIDConnectServiceImpl implements OpenIDConnectService {
	...
	public OIDConnectConfiguration getOIDCConfiguration(String endpoint) {
		...
		result.setToken_endpoint(issuer+OAUTH_2_TOKEN);
		result.setUserinfo_endpoint(issuer+OAUTH_2_USER_INFO);
		result.setRevocation_endpoint(issuer+OAUTH_2_REVOKE);
		result.setJwks_uri(issuer+OAUTH_2_JWKS);
		result.setRegistration_endpoint(issuer+OAUTH_2_CLIENT);
		...
		result.setService_documentation("https://help.synapse.org/docs/");
