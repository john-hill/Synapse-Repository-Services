...
public class DiscussionBroadcastMessageBuilderTest {
	...
	public void testGetRelatedUsersOverAtLimit(){
		...
		when(mockUserManager.getDistinctUserIdsForAliases(anyCollection(), anyLong(), anyLong())).thenReturn(set);
		// call under test
	...
	public void testGetRelatedUsersOverLimit(){
		...
		// validate paging
		verify(mockUserManager).getDistinctUserIdsForAliases(anyCollection(), eq(DiscussionBroadcastMessageBuilder.MAX_USER_IDS_PER_MESSAGE+1), eq(0L));
	}
	...
	public void testGetRelatedUsersWithMentionedUsers() {
		...
		when(mockUserManager.getDistinctUserIdsForAliases(anyCollection(), anyLong(), anyLong())).thenReturn(idSet);
		builder = new DiscussionBroadcastMessageBuilder(actorUsername, actorUserId,
