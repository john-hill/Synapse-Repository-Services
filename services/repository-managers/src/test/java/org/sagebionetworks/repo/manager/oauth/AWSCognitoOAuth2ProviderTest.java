...
public class AWSCognitoOAuth2ProviderTest {
	
	String apiKey;
	String apiSecret;
	OIDCConfig mockConfig;
	AWSCognitoOAuth2Provider provider;
	...
	public void before(){
		...
		provider = new AWSCognitoOAuth2Provider(apiKey, apiSecret, mockConfig);
	}
	...
	public void testGetAuthorizationUrl(){
		...
		assertEquals(authEndpoint + "?response_type=code&client_id=fake key&redirect_uri=https%3A%2F%2Fdomain.com&scope=openid%20email", authUrl);
	}
}
