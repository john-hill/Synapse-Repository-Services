...
public class ValidatedFamilyNameClaimProviderTest {
	...
	@InjectMocks
	private ValidatedFamilyNameClaimProvider claimProvider;
	
	private static final String USER_ID = "101";
	
	private static final String FAMILY_NAME = "validated last name";
	...
	public void testClaim() {
		// method under test
		assertEquals(OIDCClaimName.validated_family_name, claimProvider.getName());
		// method under test
		...
		// method under test
		assertEquals(FAMILY_NAME, claimProvider.getClaim(USER_ID, null, null));
	}
}
