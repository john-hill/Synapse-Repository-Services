...
public class ValidatedGivenNameClaimProviderTest {
	
	@Mock
	private UserProfileManager mockUserProfileManager;
	
	@InjectMocks
	private ValidatedGivenNameClaimProvider claimProvider;
	
	private static final String USER_ID = "101";
	
	private static final String GIVEN_NAME = "validated first name";
	...
	public void testClaim() {
		// method under test
		assertEquals(OIDCClaimName.validated_given_name, claimProvider.getName());
		// method under test
