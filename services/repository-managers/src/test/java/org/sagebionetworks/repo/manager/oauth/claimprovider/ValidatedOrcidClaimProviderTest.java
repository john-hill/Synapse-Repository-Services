...
public class ValidatedOrcidClaimProviderTest {
	
	@Mock
	private UserProfileManager mockUserProfileManager;
	
	@InjectMocks
	private ValidatedOrcidClaimProvider claimProvider;
	
	private static final String USER_ID = "101";
	
	private static final String ORCID = "validated orcid";
	...
	public void testClaim() {
		// method under test
		assertEquals(OIDCClaimName.validated_orcid, claimProvider.getName());
		// method under test
