...
public class CommunityController extends BridgeBaseController {
	...
	public @ResponseBody
	Community createCommunity(@RequestParam(value = AuthorizationConstants.USER_ID_PARAM, required = false) Long userId,
	...
	public @ResponseBody
	Community getCommunity(@RequestParam(value = AuthorizationConstants.USER_ID_PARAM, required = false) Long userId,
	...
	public @ResponseBody
	Community updateCommunity(@RequestParam(value = AuthorizationConstants.USER_ID_PARAM, required = false) Long userId,
	...
	public void deleteCommunity(@PathVariable String id,
			@RequestParam(value = AuthorizationConstants.USER_ID_PARAM, required = false) Long userId) throws NotFoundException {
