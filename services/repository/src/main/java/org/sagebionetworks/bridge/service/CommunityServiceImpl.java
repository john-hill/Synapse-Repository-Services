...
public class CommunityServiceImpl implements CommunityService {
	...
	@Override
	public void addCommunityAdmin(Long userId, String communityId, String memberId) throws DatastoreException,
			NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userId);
	...
	@Override
	public void removeCommunityAdmin(Long userId, String communityId, String memberId) throws DatastoreException, NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userId);
