...
public interface FileUploadService {
	 ...
	 */
	FileHandleResults uploadFiles(Long userName, FileItemIterator itemIterator) throws DatastoreException, NotFoundException, FileUploadException, IOException, ServiceUnavailableException;
