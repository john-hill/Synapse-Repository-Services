...
//	public static final String TOKEN_ID = "{tokenId}/{filename}.{mimeType}";
	...
	public static final String ENTITY_HIERARCHY_CHANGE = ENTITY + "/hierarchy/change";
	public static final String ENTITY_HIERARCHY_CHANGE_START = ENTITY_HIERARCHY_CHANGE+ASYNC_START_REQUEST;
	public static final String ENTITY_HIERARCHY_CHANGE_GET = ENTITY_HIERARCHY_CHANGE+ASYNC_GET_REQUEST;
