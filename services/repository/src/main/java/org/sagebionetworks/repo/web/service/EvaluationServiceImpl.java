...
public class EvaluationServiceImpl implements EvaluationService {
	...
	public Evaluation createEvaluation(Long userName, Evaluation eval) 
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public Evaluation updateEvaluation(Long userName, Evaluation eval)
			throws DatastoreException, NotFoundException, UnauthorizedException,
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void deleteEvaluation(Long userName, String id)
			throws DatastoreException, NotFoundException, UnauthorizedException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public Participant addParticipant(Long userName, String evalId) throws NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void removeParticipant(Long userName, String evalId,
	...
	@Override
	public Submission getSubmission(Long userName, String submissionId)
			throws DatastoreException, NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	public SubmissionStatus getSubmissionStatus(Long userName, String submissionId)
			throws DatastoreException, NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public SubmissionStatus updateSubmissionStatus(Long userName,
	...
	@Deprecated
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void deleteSubmission(Long userName, String submissionId)
			throws DatastoreException, NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	public PaginatedResults<Submission> getAllSubmissions(Long userName, String evalId,
	...
	@Override
	public PaginatedResults<SubmissionStatus> getAllSubmissionStatuses(Long userName, String evalId,
			SubmissionStatusEnum status, long limit, long offset, HttpServletRequest request)
			throws DatastoreException, UnauthorizedException, NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	public PaginatedResults<SubmissionBundle> getAllSubmissionBundles(Long userName, String evalId,
			SubmissionStatusEnum status, long limit, long offset, HttpServletRequest request)
			throws DatastoreException, UnauthorizedException, NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	public PaginatedResults<Submission> getMyOwnSubmissionsByEvaluation(
			String evalId, Long userName, long limit, long offset, HttpServletRequest request)
			throws DatastoreException, NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	public URL getRedirectURLForFileHandle(Long userName, 
	...
	@Override
	public long getSubmissionCount(Long userName, String evalId) throws DatastoreException,
			NotFoundException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	@Deprecated
	public <T extends Entity> boolean hasAccess(String id, Long userName,
	...
	@Override
	public AccessControlList createAcl(Long userName, AccessControlList acl)
	...
	@Override
	public AccessControlList updateAcl(Long userName, AccessControlList acl)
			throws NotFoundException, DatastoreException,
			InvalidModelException, UnauthorizedException,
			ConflictingUpdateException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	public void deleteAcl(Long userName, String evalId)
			throws NotFoundException, DatastoreException,
			InvalidModelException, UnauthorizedException,
			ConflictingUpdateException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	public AccessControlList getAcl(Long userName, String evalId)
			throws NotFoundException, DatastoreException,
	...
	public UserEvaluationPermissions getUserPermissionsForEvaluation(
			Long userName, String evalId) throws NotFoundException,
			DatastoreException {
		UserInfo userInfo = userManager.getUserInfo(userName);
	...
	@Override
	public QueryTableResults query(String userQuery, Long userName) 
