...
public class SubmissionReplicationIntegrationTest {
	...
	public void testSubmissionReplication() throws Exception {
		...
		ObjectDataDTO data = asyncHelper.waitForObjectReplication(ReplicationType.SUBMISSION, submissionId, etag, MAX_WAIT);
		...
		data = asyncHelper.waitForObjectReplication(ReplicationType.SUBMISSION, submissionId, etag, MAX_WAIT);
